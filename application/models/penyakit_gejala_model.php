...
class penyakit_gejala_model extends CI_Model {
    ...
    function get_last_ten_penyakit_gejala($limit, $offset) {
        $this->db->select('gejala_penyakit.kd_penyakit, penyakit.nm_penyakit, gejala.nm_gejala');
        $this->db->from('penyakit, gejala_penyakit, gejala');
        $this->db->where('gejala_penyakit.kd_penyakit = penyakit.kd_penyakit AND gejala_penyakit.kd_gejala = gejala.kd_gejala');

...
/**
 * Description of Penyakit_Penyebab
 *
 * @author ardi
 */
class Penyakit_Penyebab extends CI_Controller {
    ...
    //pemberian title halaman penyakit
        ...
        $this->table->add_row($i, 'P0111', 'gatal-gatal', anchor('penyakit_penyebab/update/' . $i, 'update', array('class' => 'update')) . ' ' .
            anchor('penyakit_penyebab/delete/' . $i, 'hapus', array('class' => 'delete', 'onclick' => "return confirm('Anda yakin akan menghapus data ini?')"))
        );

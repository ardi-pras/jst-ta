...
class Penyebab extends CI_Controller {
    ...
    //pemberian title halaman penyakit
        ...
        $this->table->add_row($i, 'P0111', 'kulit kotor', anchor('penyebab/update/' . $i, 'update', array('class' => 'update')) . ' ' .
            anchor('penyebab/delete/' . $i, 'hapus', array('class' => 'delete', 'onclick' => "return confirm('Anda yakin akan menghapus data ini?')"))
        );

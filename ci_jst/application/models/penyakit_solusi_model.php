...
class penyakit_solusi_model extends CI_Model {
    ...
    function get_last_ten_penyakit_solusi($limit, $offset) {
        $this->db->select('solusi_penyakit.kd_solusi, solusi_penyakit.kd_penyakit, penyakit.nm_penyakit, solusi_penyakit.nm_solusi');
        $this->db->from('penyakit, solusi_penyakit');
        $this->db->where('solusi_penyakit.kd_penyakit = penyakit.kd_penyakit');
    ...
    function get_penyakit_solusi_by_id($kd_penyakit) {
        $this->db->select('solusi_penyakit.kd_solusi, penyakit.nm_penyakit, solusi_penyakit.nm_solusi');
        $this->db->from('penyakit, solusi_penyakit');
        $this->db->where('solusi_penyakit.kd_penyakit = penyakit.kd_penyakit');
